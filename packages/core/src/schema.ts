...
export const markets = sqliteTable(
  "markets",
  {
    ...
    event_ticker: text("event_ticker"),
    series_ticker: text("series_ticker"),
    ...
    market_shape: text("market_shape").notNull().default("unknown"),
    is_binary_eligible: integer("is_binary_eligible", { mode: "boolean" }).notNull().default(false),
